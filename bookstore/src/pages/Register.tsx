...
function Register() {
  ...
  function handleInputChange(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (name === 'confirm_password' && value !== formValues.password) checkErrors.confirm_password = 'Las contraseñas no coinciden';
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>){
    ...
    try {
      const resp = await axios.post('http://localhost:3000/register', formValues);
    ...
    <div className="flex items-center justify-center min-h-screen">
      <form onSubmit={handleSubmit} className="w-full max-w-sm">
        ...
        <div className="md:flex md:items-center mb-6">
          ...
          <div className="md:w-2/3">
            <input ref={inputRef} name="photo" value={formValues.photo} onChange={handleInputChange} 
        ...
        <div className="md:flex md:items-center mb-6">
          ...
          <div className="md:w-2/3">
            ...
            className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" placeholder="******"/>
